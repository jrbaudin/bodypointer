...
@interface PoseDetectionFrameProcessorPlugin : FrameProcessorPlugin
@end

@implementation PoseDetectionFrameProcessorPlugin
...
// Export the frame processor for VisionCamera
VISION_EXPORT_FRAME_PROCESSOR(PoseDetectionFrameProcessorPlugin, poseDetection)
